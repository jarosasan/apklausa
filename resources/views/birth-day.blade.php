...
@section('content')
    <form class="text-center form" action="{{route('storeAge', $user->id)}}" method="post">
        @csrf()
        <div id="age">
            <h2 class="title">Jūsų gimimo data?</h2>
            <div class="form-row mb-3">
                <div class="form-group">
                    <label for="select1">Year</label>
                    <select class="form-control form-control-lg" name="year" id="select1">
                        <option >---</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-lg" name="month" id="exampleFormControlSelect1">
                        <option >---</option>
                        ...
                        <option value="08">Rugpjutis</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-lg" name="day" id="exampleFormControlSelect1">
                        <option>---</option>
